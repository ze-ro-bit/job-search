...
;// CONCATENATED MODULE: ./src/js/searchJob.js
function searchJob() {
  ...
  fetch("https://jsearch.p.rapidapi.com/search?query=" + searchInput + "&page=1&num_pages=1", options).then(function (response) {
    return response.json();
  }).then(function (response) {
    console.log(response);
    console.log(response.data.length);
    var employerName = document.getElementsByClassName("employer-name");
    var jobDesc = document.getElementsByClassName("job-description");
    var jobTitle = document.getElementsByClassName("job-title");
    var jobCity = document.getElementsByClassName("job-city");
    var employmentType = document.getElementsByClassName("employment-type");
    var jobLink = document.getElementsByClassName("job-link");
    document.getElementById("search-title").innerHTML = "Search results for: " + searchInput;
